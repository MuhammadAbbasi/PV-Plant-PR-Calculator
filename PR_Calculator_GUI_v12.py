...
class PRCalculatorGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Calcolatore Performance Ratio (PR) Fotovoltaico Mazara 01 - v12.0")
    ...
    def create_layout(self):
        ...
        # Version badge
        version_badge = tk.Label(header_inner, text="v12.0", bg="#e8f0fe", fg="#1a73e8", font=("Segoe UI Semibold", 9), padx=8, pady=2)
    ...
    def run_calculation(self, folder, date_str, pvsyst_pr, threshold, diff_threshold=0.10, poa_method="condmax"):
        try:
            import datetime
