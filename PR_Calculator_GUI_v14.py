...
v14.0 - 2026-09-01
  ...
  * Versione GUI e log aggiornati a v14.0.
...
class PRCalculatorGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Calcolatore Performance Ratio (PR) Fotovoltaico Mazara 01 - v14.0")
        ...
        # v14: Data source selection (SCADA, VCOM, or Misto)
        ...
        print(">>> GET SRL - Motore di calcolo Performance Ratio inizializzato (v14).")
    ...
    def create_layout(self):
        ...
        # Version badge
        version_badge = tk.Label(header_inner, text="v14.0", bg="#e8f0fe", fg="#1a73e8", font=("Segoe UI Semibold", 9), padx=8, pady=2)
        ...
        # v14: Data source selector (SCADA vs VCOM vs Misto)
        ...
        # Dedicated vendor PR sync buttons frame (v14)
    ...
    def _sync_vendor_pr_worker(self, vendor_type):
        ...
        try:
            ...
            if not os.path.exists(mother_path):
                # Search for any 00 PR_recalculation_*.xlsx in calcolo_folder
